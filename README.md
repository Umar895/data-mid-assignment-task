...
Solution:
* Change the mapping directory in docker-compose file in volumne section(volumes: - /home/umar/Downloads/test_data:/test_data/)
* docker-compose build
* docker-compose up
* result will be 2 desired tables inserted to postgres
